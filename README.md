# Backgammon Club Ranking List

This repo contains the webpage to handle Backgammon Club Ranking Lists. The acutal lists are stored and maintained on GitHub.
